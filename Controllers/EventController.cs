...
namespace Modas.Controllers
{
    ...
    public class EventController : Controller
    {
        ...
        public Event Get(int id) => eventDbContext.Events
            ...
            .FirstOrDefault(e => e.EventId == id) ?? throw new InvalidOperationException();
        
        [HttpGet("pageSize/{pageSize:int}/page/{page:int}")]
        // returns all events by page
        public EventPage GetPage(string? sortBy, string? order, int pageSize = 10, int page = 1) => new EventPage
        {
